    ...
    <head>
        ...
        <style>
            * { box-sizing: border-box; margin: 0; padding: 0; }
            ...
            .ticker { font-size: 20px; font-weight: bold; cursor: pointer; text-decoration: underline; text-decoration-color: #333; }
            ...
            .vulcan-input { width: 100%; padding: 12px; background: #0a0a0f; border: 1px solid #333; border-radius: 8px; color: #fff; font-size: 14px; outline: none; }
            .vulcan-btn-green { padding: 12px 20px; background: #00ff88; color: #000; border: none; border-radius: 8px; font-weight: bold; cursor: pointer; white-space: nowrap; }
            .vulcan-btn-outline { padding: 12px 20px; background: #1a1a2e; color: #00ff88; border: 1px solid #00ff88; border-radius: 8px; font-weight: bold; cursor: pointer; white-space: nowrap; }
            ...
            .modal-content { background: #12121a; border: 1px solid #333; border-radius: 12px; padding: 20px; max-width: 800px; margin: 40px auto; }
    ...
    <body>
        ...
        <div class="card">
            ...
            <div style="border-top:1px solid #222; padding-top:15px; margin-top:15px;">
                ...
                <div class="input-row input-row-4">
                    ...
                    <input id="settingsGmailPass" type="password" placeholder="Gmail app password" class="vulcan-input">
        ...
        <div class="modal" id="chartModal">
            <div class="modal-content">
                ...
                <h2 id="chartTitle" style="color:#00ff88; margin-bottom:15px;"></h2>
                        ...
                        if (data.buys.length > 0) {
                            ...
                            data.buys.forEach(stock => {
                                html += `<div style="padding:10px; background:#0a0a0f; border-radius:8px; margin-bottom:8px; display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:8px;">
                                    <span style="font-weight:bold; cursor:pointer; color:#00ff88;" onclick="showChart('${stock.ticker}')">${stock.ticker} 📊</span>
            ...
            function saveSettings() {
                fetch('/save_settings', {
                    ...
                    body: JSON.stringify({
                        ...
                        gmail_user: document.getElementById('settingsGmailUser').value,
                        gmail_pass: document.getElementById('settingsGmailPass').value
                    })
            ...
            function loadHoldings() {
                fetch('/holdings')
                    ...
                    .then(data => {
                        ...
                        html += `<div style="padding:12px; border-top:1px solid #222; margin-top:8px; display:flex; justify-content:space-between; flex-wrap:wrap; gap:8px;">
                            <span style="color:#888;">Total Value</span>
                            <span style="font-weight:bold;">$${totalValue.toFixed(2)}</span>
                            <span style="color:${totalPnl >= 0 ? '#00ff88' : '#ff4455'};">${totalPnl >= 0 ? '+' : ''}$${totalPnl.toFixed(2)} P&L</span>
                        </div>`;
                        div.innerHTML = html;
                    });
            }
                    ...
                    .then(data => {
                        ...
                        new Chart(ctx, {
                            ...
                            options: {
                                ...
                                scales: {
                                    x: { ticks: { color: '#555', maxTicksLimit: 6 }, grid: { color: '#1a1a1a' } },
